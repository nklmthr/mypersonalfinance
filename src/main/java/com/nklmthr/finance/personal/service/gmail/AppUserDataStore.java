...
public class AppUserDataStore<V extends java.io.Serializable> extends AbstractDataStore<V> {
    ...
    protected AppUserDataStore(AppUserDataStoreFactory factory, AppUser appUser,
                               AppUserRepository appUserRepository, String id) {
        super(factory, id);
        ...
        if (appUser.getGmailAccessToken() != null) {
            StoredCredential cred = new StoredCredential()
                    .setAccessToken(appUser.getGmailAccessToken())
    ...
    public DataStore<V> set(String key, V value) throws IOException {
        if (!"user".equals(key)) throw new IOException("Only 'user' key supported");
