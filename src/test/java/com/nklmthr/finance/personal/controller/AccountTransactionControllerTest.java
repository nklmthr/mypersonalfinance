...
class AccountTransactionControllerTest {
    ...
    void getById_found() throws Exception {
        AccountTransactionDTO dto = new AccountTransactionDTO("t1", java.time.LocalDateTime.now(), BigDecimal.ONE, "d", null, null, null, TransactionType.DEBIT, new AccountDTO("a","A", BigDecimal.ZERO, null, null, null, null, null), new CategoryDTO(), null, List.of(), null, null, null, null, null, null, null, null);
    ...
    void create_returns200() throws Exception {
        AccountTransactionDTO in = new AccountTransactionDTO(null, java.time.LocalDateTime.now(), BigDecimal.ONE, "d", null, null, null, TransactionType.DEBIT, new AccountDTO("a","A", BigDecimal.ZERO, null, null, null, null, null), new CategoryDTO(), null, List.of(), null, null, null, null, null, null, null, null);
        AccountTransactionDTO out = new AccountTransactionDTO("t1", java.time.LocalDateTime.now(), BigDecimal.ONE, "d", null, null, null, TransactionType.DEBIT, new AccountDTO("a","A", BigDecimal.ZERO, null, null, null, null, null), new CategoryDTO(), null, List.of(), null, null, null, null, null, null, null, null);
