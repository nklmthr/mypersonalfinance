...
class AccountTransactionMapperTest {
    ...
    void toEntity_mapsParentAndIgnoresAppUser() {
        ...
        AccountTransactionDTO dto = new AccountTransactionDTO("t1", LocalDateTime.now(), new BigDecimal("10"), "d", null, null, null, TransactionType.CREDIT, a, c, "p1", java.util.List.of(), null, null, null, null, null, null);
